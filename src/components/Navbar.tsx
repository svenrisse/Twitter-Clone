...
export default function Navbar({ focused }: { focused?: string }) {
  ...
  return (
    <div className="fixed bottom-0 flex w-screen items-center rounded-t-md bg-slate-700 py-2 lg:left-14 lg:top-24 lg:h-56 lg:w-2/12 lg:rounded-xl lg:bg-slate-200 xl:left-52">
      <ProfileBar />
